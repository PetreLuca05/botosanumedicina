...
function Slide2() {
  ...
  function handleLearnMore() {
    navigate('/botosanumedicina/muschi');
  ...
  return (
    <div className="overlay-container">
      <article>
        <h2>acțiunea musculară</h2>
        <p>Acțiunea musculară reprezintă procesul prin care mușchii se contractă și relaxează 
          pentru a produce mișcare. Contracția musculară este declanșată de impulsuri nervoase, 
          care determină fibrele musculare să se scurteze și să genereze forță. Acest mecanism permite organismului să 
          efectueze activități precum mersul, respirația sau pomparea sângelui prin inimă.</p>
