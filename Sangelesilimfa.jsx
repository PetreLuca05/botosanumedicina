...
Command: npx gltfjsx@6.5.3 public/models/sangelesilimfa.glb 
*/
...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/sangelesilimfa.glb')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Top_Vein">
          ...
          <mesh name="BézierCurve007_1" geometry={nodes.BézierCurve007_1.geometry} material={materials.Black} />
        </group>
        <mesh name="Limfa_Extras" geometry={nodes.Limfa_Extras.geometry} material={materials.M2} />
        ...
        <group name="Bottom_Vein">
          ...
          <mesh name="BézierCurve015_1" geometry={nodes.BézierCurve015_1.geometry} material={materials.Black} />
        </group>
        <group name="Limfa">
          <mesh name="BézierCurve016" geometry={nodes.BézierCurve016.geometry} material={materials.M2} />
          <mesh name="BézierCurve016_1" geometry={nodes.BézierCurve016_1.geometry} material={materials['Limfa Cell']} />
        </group>
...
useGLTF.preload('/sangelesilimfa.glb')
